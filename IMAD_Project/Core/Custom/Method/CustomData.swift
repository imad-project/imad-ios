...
class CustomData{
    ...
    let user = UserResponse(email: "quarang@gamil.com", nickname: "콰랑",gender: "FEMALE", birthYear: 1999, profileImage: 3,tvGenre: [10759,16,35],movieGenre: [28,12,16], ageRange: 2, authProvider: "IMAD", role: "USER")
