...
class ProfileImageApiService{
    ...
    static func fetchProfileImageCustom(image:Data) -> AnyPublisher<ProfileImage,AFError>{
        ...
        return ApiClient.shared.session
            ...
            .publishDecodable(type: ProfileImage.self)
            .value()
    ...
    static func fetchProfileImageDefault(image:String) -> AnyPublisher<ProfileImage,AFError>{
