...
class CustomSlider: ObservableObject {
    ...
    var percentagesBetween: String {
        return String(format: "%.0f", highHandle.currentPercentage.wrappedValue - lowHandle.currentPercentage.wrappedValue)
    }
...
struct SliderPathBetweenView: View {
    ...
    var body: some View {
        ...
        .stroke(Color.customIndigo, lineWidth: slider.lineWidth)
    }
}
